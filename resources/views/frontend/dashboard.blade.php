                        ...
                        <div class="de-flex sm-pt10">
                            ...
                            <div class="de-flex-col header-col-mid">
                                <ul id="mainmenu">
                                    ...
                                    <li><a class="menu-item" href="{{ url('/car-list') }}">Arabalar</a></li>
                                    <li><a class="menu-item" href="quick-booking.html">Hızlı Rezervasyon</a></li>
                                    <li><a class="menu-item" href="contact.html">İletişim</a></li>
